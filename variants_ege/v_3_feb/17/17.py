...
cnt = cnt_odd * cnt_31_odd + sum([i - 1 for i in range(1, cnt_31_odd + 1)]) +\
      cnt_even * cnt_31_even + sum([i - 1 for i in range(1, cnt_31_even + 1)])

print(cnt, max([max_num_31_odd + max_num_odd, max_num_31_even + max_num_even]))
